...
internal class ReflectionLinker<TNative>(BindingFlags bindingFlags) : ILinker<TNative>
{
    ...
    public IDecoder<TEntity> CreateDecoder<TEntity>(IFormat<TNative> format, ISchema<TNative, TEntity> schema)
    {
        ...
        var context = new DecodeContext<TNative>(automatic, bindingFlags, format, new Dictionary<Type, object>());
    ...
    public IEncoder<TEntity> CreateEncoder<TEntity>(IFormat<TNative> format, ISchema<TNative, TEntity> schema)
    {
        ...
        var context = new EncodeContext<TNative>(automatic, bindingFlags, format, new Dictionary<Type, object>());
